  ...
  <div class="modal-overlay" id="${MODAL_ID}">
    <div class="modal">
      ...
      <div id="note-replace-mode" style="display:none">
        ...
        <p style="font-size:calc(13px * var(--type-scale));color:var(--neutral-500);margin-bottom:12px;line-height:1.55">Paste your SOAP note below -- it will replace what HealthCoach uses for this session.</p>
