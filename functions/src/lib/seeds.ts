...
/** Synthetic interim-care events after the demo visit (Feb 14, 2025); used for since-visit recap LLM input. */
export const SINCE_VISIT_TIMELINE_SEED = JSON.parse(String.raw`{
  "anchorVisitDate": "February 14, 2025",
  "anchorProvider": "Dr. Sarah Chen, MD",
  "symptomsManaged": [
    "GERD symptoms mostly improved on omeprazole 20 mg daily since the visit.",
    "Occasional breakthrough reflux when eating late or lying down soon after dinner.",
    "No recurrent chest pain after ED evaluation on March 28, 2025."
  ],
  "medicationChanges": [
    "Omeprazole 20 mg once daily before breakfast started at the Feb 14 visit.",
    "Lisinopril 10 mg once daily started March 14, 2025 by clinical pharmacist for borderline blood pressure.",
    "Atorvastatin 40 mg daily and aspirin 81 mg daily continued without change."
  ],
  "portalAndPhoneCommunication": [
    "Feb 26, 2025: patient portal message about persistent reflux; PCP advised continuing PPI and trigger avoidance.",
    "Mar 5, 2025: medical assistant phone call with fasting lipid panel results (LDL 142, HDL 45, triglycerides 168).",
    "Apr 4, 2025: portal message about mild dry cough after starting lisinopril; PharmD reviewed and plan to continue with monitoring."
  ],
  "clinicalPharmacistVisits": [
    "Mar 14, 2025: telehealth visit with Dr. Maya Patel, PharmD for hypertension medication initiation and education.",
    "Apr 11, 2025: in-person visit with PharmD; home BP log averaged about 134/84 over two weeks."
  ],
  "acuteCareEvents": [
    "Mar 28, 2025: ED visit at BIDMC for atypical chest discomfort; EKG normal, troponins x2 negative, chest X-ray clear; discharged with GERD flare guidance and PCP follow-up."
  ],
  "diagnosticTests": [
    "Feb 28, 2025: fasting lipid panel as ordered at prior visit (values documented in MA call Mar 5).",
    "Mar 28, 2025: ED workup as above (EKG, troponins, chest X-ray).",
    "Apr 22, 2025: outpatient treadmill stress test ordered after ED visit; reported normal with low-risk Duke score."
  ]
}`);
